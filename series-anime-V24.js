        ...
        setTimeout(() => {
            ...
            if (v) {
                ...
                if (!skipBtn) {
                    ...
                    skipBtn.style.cssText = 'position:absolute;bottom:140px;right:20px;padding:8px 16px;background:rgba(0,230,118,0.9);color:#000;border:none;border-radius:6px;font-weight:700;font-size:13px;cursor:pointer;opacity:0;transition:opacity 0.3s;z-index:9999;pointer-events:auto';
