        ...
        setTimeout(() => {
            ...
            if (v) {
                ...
                const checkIntro = () => {
                    ...
                    if (ie > 0) {
                        console.log('[Skip Intro] introEnd:', ie, 'currentTime:', ct, 'paused:', v.paused);
                    }
                    
                    // Mostrar botón si:
                    // 1. Hay introEnd definido y es mayor que 0
                    // 2. El tiempo actual está antes del final de la intro
                    // 3. El video NO está pausado
                    if (ie > 0 && ct < ie && !v.paused) {
                ...
                v.addEventListener('playing', checkIntro); // Agregado para mayor confiabilidad
