    ...
    if (typeof window.WolfPlayer !== 'undefined') {
        ...
        setTimeout(() => {
            ...
            if (v) {
                ...
                skipBtn._skipHandlerAttached = skipBtn._skipHandlerAttached || false;
                ...
                const checkIntro = () => {
                    ...
                    // Ocultar si no hay introEnd definido
                    if (!ie || ie <= 0) {
                        skipBtn.style.opacity = '0';
                        skipBtn.style.pointerEvents = 'none';
                        return;
                    ...
                    // Mostrar solo si está reproduciendo, dentro del rango de intro
                    if (v.currentTime < ie && v.currentTime > 0 && !v.paused) {
